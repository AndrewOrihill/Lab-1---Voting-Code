...
namespace ConsoleApp1
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            if (isEighteen == true && isCitizen == true)
            {
                System.Console.WriteLine("Then that means you can vote! Good job!");
            }
            else
            {
                System.Console.WriteLine("Sorry, that means you cannot vote.");
            }
